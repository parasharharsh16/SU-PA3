...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run the finetuned or pretrained mode.")
    parser.add_argument("--mode", type=str, default="None", help="Mode of operation (finetuned/pretrained)")
